...
Every shell assertion in this directory is atomic. The existing policy names
(`deny-git-destructive`, `deny-helm-release-mgmt`, `deny-kubectl-create`, and
so on) are presets that directly reference their atomic members from
